...
rs = requests.session()
link_href = "http://www.imdb.com/search/title?release_date=2014-07-01,&runtime=60,&title_type=feature"
bid_file = open("C:/Users/BigData/Dropbox/BoxOffice/after20140701/after20140701.txt", 'w')
page_dic = {}
while True:
