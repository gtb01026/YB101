# -*- coding: utf-8 -*-
"""
Created on Wed Jan 07 14:54:41 2015
...
def get_tn15content_table(link):
...
def insert_into_boxoffice(part):
...
for line in f.readlines():
    try:
        pkno = get_pkno (line)
        #print pkno# print pkno
        rs = requests.session()
        title = get_title(line)
        # print title
        table = get_tn15content_table(line)
        #print table
        insert_into_budget(table)
        for part in "".join(table.text).split("\n\n"):
            insert_into_boxoffice(part)
    except BaseException, e:
        print line, e
        error_detail = open("C:/Users/BigData/Dropbox/BoxOffice/after20000101/box_office_error_detail.txt", 'a')
        error = open("C:/Users/BigData/Dropbox/BoxOffice/after20000101/box_office_error.txt", 'a')
