...
cursor = cnxn.cursor()
f = open("C:/Users/BigData/Dropbox/BoxOffice/locations2error.txt", "r")
for line in f.readlines():
    try:
        ...
        print line, e
        error_detail = open("C:/Users/BigData/Dropbox/BoxOffice/locations2error_detail.txt", 'a')
        error = open("C:/Users/BigData/Dropbox/BoxOffice/locations2error.txt", 'a')
