...
f = open("C:/Users/BigData/Dropbox/BoxOffice/awardserror.txt", "r")
    ...
    try:
        ...
        for h3 in h3_coll:
            ...
            for tr in tr_coll:
                ...
                # cursor.execute("insert into awards15 values (?, ?, ?, ?, ?, ?, ?, ?, ?)", params)
                # cnxn.commit()
                print params
            count += 1
        ...
        error = open("C:/Users/BigData/Dropbox/BoxOffice/temp2.txt", 'a')
