...
rs = requests.session()
link_href = "http://www.imdb.com/search/title?at=0&release_date=2000-01-01,2014-12-31&runtime=60,&sort=year,desc&title_type=feature"
bid_file = open("C:/Users/BigData/Dropbox/BoxOffice/20000101_20141231/20000101_20141231.txt", 'w')
page_dic = {}
while True:
    if link_href not in page_dic:
        ...
        try:
            ...
            print link_href, e
            error_detail = open("C:/Users/BigData/Dropbox/BoxOffice/20000101_20141231/20000101_20141231_error_detail.txt", 'a')
            error = open("C:/Users/BigData/Dropbox/BoxOffice/20000101_20141231/20000101_20141231_error.txt", 'a')
