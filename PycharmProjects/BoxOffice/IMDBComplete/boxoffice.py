...
cursor = cnxn.cursor()
f = open("C:/Users/BigData/Desktop/2014-11-01.csv", "r")
...
#                        print len(aspl_dic[j+2])
        ...
        print line, e
        error_detail = open("C:/Users/BigData/Dropbox/BoxOffice/IMDBComplete/comingsoonafter2011_2015/boxoffice_error_detail.txt", 'a')
        error = open("C:/Users/BigData/Dropbox/BoxOffice/IMDBComplete/comingsoonafter2011_2015/boxoffice_error.txt", 'a')
